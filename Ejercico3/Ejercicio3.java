...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        int temas = Lector.leerInt();
        
        
        System.out.println("Motivo");
        String motivo = Lector.leerString();
        System.out.println("Nombre del contratante");
        String nombre = Lector.leerString();
        System.out.println("Dia del evento");
        int dia = Lector.leerInt();
        
        Evento e = new Evento (motivo, nombre, dia, nombreBanda, temas);
        ...
        int fechas = Lector.leerInt();
        
        Gira g = new Gira (nombre, fechas, nombreBanda, temas);
